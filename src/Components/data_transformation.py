...
class DataTransformationConfig:
    prprocessor_obj_file_path=os.path.join("artifacts","preprocessor.pkl")
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            preprocessing_object=self.get_data_tranformation_object()
            ...
            logging.info("Applying preprcessing obbject on training and testing data")
            train_arr=np.c_[input_feature_train_arr,np.array(target_feature_train_df)]
            test_arr=np.c_[input_feature_test_arr,np.array(target_feature_test_df)]
            save_obj(
                file_path=self.data_transformation_config.prprocessor_obj_file_path,
            ...
            return(
                train_arr,
                test_arr,
                self.data_transformation_config.prprocessor_obj_file_path
            )
